 ...
 * @param glutenFree 
 */
case class BrandedFoodObjectDietLabels (
  vegan: Option[BrandedFoodObject_diet_labels_vegan] = None,
  vegetarian: Option[BrandedFoodObject_diet_labels_vegetarian] = None,
  glutenFree: Option[BrandedFoodObject_diet_labels_gluten_free] = None
)
