...
case class BrandedFoodObjectItems (
  ...
  `package`: Option[BrandedFoodObject_package] = None,
  serving: Option[BrandedFoodObject_serving] = None,
  categories: Option[List[String]] = None,
  nutrients: Option[List[BrandedFoodObject_nutrients]] = None,
  dietLabels: Option[BrandedFoodObject_diet_labels] = None,
  dietFlags: Option[List[BrandedFoodObject_diet_flags]] = None,
  packagingPhotos: Option[BrandedFoodObject_packaging_photos] = None,
  allergens: Option[List[String]] = None,
  brandList: Option[List[String]] = None,
  countries: Option[List[String]] = None,
  countryDetails: Option[BrandedFoodObject_country_details] = None,
  palmOilIngredients: Option[List[String]] = None,
  ingredientList: Option[List[String]] = None,
  hasEnglishIngredients: Option[Boolean] = None,
  minerals: Option[List[String]] = None,
  traces: Option[List[String]] = None,
  vitamins: Option[List[String]] = None,
