...
case class IngredientObjectItems (
  ...
  nutrients: Option[List[IngredientObject_nutrients]] = None,
  calorieConversionFactor: Option[IngredientObject_calorie_conversion_factor] = None,
  proteinConversionFactor: Option[BigDecimal] = None,
  components: Option[List[IngredientObject_components]] = None,
  portions: Option[List[IngredientObject_portions]] = None,
