...
case class BrandedFoodObjectDietFlags (
  ...
  ingredientDescription: Option[String] = None,
  dietLabel: Option[String] = None,
  isCompatible: Option[String] = None,
  compatibilityLevel: Option[Integer] = None,
  compatibilityDescription: Option[String] = None,
  isAllergen: Option[Boolean] = None
)
